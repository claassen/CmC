...
namespace CmC.Compiler.Architecture
{
    ...
    public enum Register
    {
        ...
        IDTBR, //Interrupt descriptor table base register
    ...
    public class RIVMArchitecture : IArchitecture
    {
        ...
        {
            return Encode(OpCode.IRET, 0, 0, 0, ir.OperandSize, false);
        }
        ...
        {
            return Encode(OpCode.SETIDT, 0, 0, 0, 4, true, ir.Address.Value);
        }
