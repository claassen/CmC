...
{
    [TokenExpression("MULT", "'mult' REGISTER ',' REGISTER '->' REGISTER")]
    public class Mult : ILanguageNonTerminalToken, ICodeEmitter
    {
        public string Left;
        public string Right;
        ...
        {
            context.EmitInstruction(new IRMult() { Left = Left, Right = Right, To = Destination });
        }
